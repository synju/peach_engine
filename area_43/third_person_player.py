...
from area_43.cameras.third_person_camera import ThirdPersonCamera
...
class ThirdPersonPlayer:
    ...
    def _draw_debug_position_sphere(self):
        ...
        for i in range(segments + 1):
            ...
            if i == 0:
                lines.moveTo(
                    self.position[0] + x, self.position[1], self.position[2] + z
                )
            else:
                lines.drawTo(
                    self.position[0] + x, self.position[1], self.position[2] + z
        ...
        for i in range(segments + 1):
            ...
            if i == 0:
                lines.moveTo(
                    self.position[0], self.position[1] + y, self.position[2] + z
                )
            else:
                lines.drawTo(
                    self.position[0], self.position[1] + y, self.position[2] + z
